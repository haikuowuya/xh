...
public abstract class DrawerArrowDrawable extends Drawable
{
    ...
    public DrawerArrowDrawable(Context context)
    {
        ...
        this.mSize = com.xinheng.util.DensityUtils.dpToPx(context, 50);
        this.mBarSize = com.xinheng.util.DensityUtils.dpToPx(context, 18);
        this.mTopBottomArrowSize = com.xinheng.util.DensityUtils.dpToPx(context, 14);  //11
        this.mBarThickness = com.xinheng.util.DensityUtils.dpToPx(context, 2);
        this.mBarGap = com.xinheng.util.DensityUtils.dpToPx(context, 3);
        this.mMiddleArrowSize = com.xinheng.util.DensityUtils.dpToPx(context, 20); //16
    ...
    public static final class BackDrawerArrowDrawable extends DrawerArrowDrawable
    {
        public BackDrawerArrowDrawable(Context context)
        {
            super(context);
            setProgress(1.f);
        }
