 ...
 * 提交预约挂号的接口实现
 */
public class SubmitAppointmentPresenterImpl implements SubmitAppointmentPresenter
{
    ...
    public SubmitAppointmentPresenterImpl(BaseActivity activity, DataView dataView)
    {
        mActivity = activity;
        mDataView = dataView;
    }

    public SubmitAppointmentPresenterImpl(BaseActivity activity, DataView dataView, String requestTag)
    {
        mActivity = activity;
        mDataView = dataView;
