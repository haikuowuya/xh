...
@SuppressLint("ViewConstructor") public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout
{
    ...
    public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs)
    {
        ...
        switch (mode)
        {
            ...
            default:
                ...
                {
                    Log.w("PTR", "请使用属性ptrDrawableStart来代替ptrDrawableTop");
            ...
            case PULL_FROM_END:
                ...
                {
                    Log.w("PTR", "请使用属性ptrDrawableEnd来代替ptrDrawableBottom");
